...
class StrategyModuleFusion:
    ...
    def _generate_rationale(
        ...
        if self.cfg["llm"]["enabled"] and context and "llm_client" in context:
            try:
                return self._generate_llm_rationale(intent, goals, sr_score, context)
            except:
                pass  # Fallback para determinístico
