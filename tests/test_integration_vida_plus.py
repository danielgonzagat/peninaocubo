...
class TestVidaPlusIntegration:
    ...
    def test_caos_kratos_integration(self):
        ...
        phi_adaptive = adaptive_kratos(0.5, 0.6, 0.7, 0.8, 
    ...
    def test_marketplace_integration(self):
        ...
        needs = [
            Need("agent1", "cpu_time", 10.0, 0.5),
            Need("agent2", "memory", 5.0, 0.3)
        ]
        
        offers = [
            Offer("provider1", "cpu_time", 15.0, 0.4),
            Offer("provider2", "memory", 8.0, 0.2)
        ]
    ...
    def test_full_pipeline_integration(self):
        ...
        phi_kratos_val = adaptive_kratos(0.8, 0.7, 0.6, 0.9, 
                                       current_performance=G_swarm)
        ...
        numeric_state = {k: v for k, v in evolution_state.items() 
