...
def test_market_matching():
    ...
    needs = [
        ...
        Need("agent2", "memory", 8.0, 3.0)
    ]
    
    offers = [
        Offer("agent3", "cpu", 15.0, 4.0),
        Offer("agent4", "memory", 10.0, 2.5)
    ]
...
def test_darwin_audit():
    ...
    # Select variant
    variants = [
        {"darwin_score": score_high},
        {"darwin_score": score_low}
    ]
