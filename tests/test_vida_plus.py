...
class TestMarketplace:
    ...
    def test_market_matching(self):
        ...
        needs = [
            Need("agent1", "cpu", 10.0, 2.0),
            Need("agent2", "memory", 5.0, 1.5)
        ]
        
        offers = [
            Offer("provider1", "cpu", 15.0, 1.5),
            Offer("provider2", "memory", 10.0, 1.0)
        ]
