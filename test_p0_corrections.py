...
def test_deterministic_seed():
    ...
    async def run_cycles(core):
        ...
        for _ in range(3):
            ...
            results.append(
                {"decision": res["decision"], "metrics": res.get("metrics", {}), "state_hash": core.xt.compute_hash()}
            )
        return results
...
def test_promote_attest_event():
    ...
    config = {"evolution": {"seed": 999, "alpha_0": 0.5}, "thresholds": {"beta_min": 0.001, "tau_caos": 0.5}}
...
def test_pydantic_config_validation():
    ...
    # Test valid config
    valid_config = {"ethics": {"ece_max": 0.01}, "evolution": {"alpha_0": 0.1}}
