...
def score_gate(x1: float, x2: float, cost: float, x4: float, w1: float, w2: float, wcost: float, w4: float, tau: float, canary_margin: float = 0.05) -> GateVerdict:
...
def linf_harmonic(metrics, weights, cost_factor=None, lambda_c: float = 0.0, ethical_ok: bool = True, **kwargs) -> float:
