...
def combined_guard_check(metrics: Dict[str, Any], risk_history: List[float], 
                        policy: 'SigmaGuardPolicy' = None) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            if not ratios:
                ...
                return GuardResult(
                    ...
                    details={"error": "no_valid_ratios"},
                    timestamp=str(time.time())
                ), violations, {"error": "no_valid_ratios"}
