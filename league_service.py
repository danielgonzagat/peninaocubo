...
class LeagueWORM:
    ...
    def record_transition(self, from_stage: DeploymentStage, to_stage: DeploymentStage,
                          variant_id: str, metrics_before: VariantMetrics,
                          metrics_after: Optional[VariantMetrics], decision: str,
                          reason: str, traffic_slice: Dict[str, Any]) -> str:
...
class LeagueOrchestrator:
    ...
    def deploy_challenger(self, variant_id: str) -> bool:
        ...
        with self._lock:
            ...
            self._schedule_stage_transition(
                self.config.shadow_duration_s,
                self._transition_to_canary
            )
            return True
    ...
    def record_request(self, variant_id: str, success: bool, latency_ms: float,
                      l_inf: float, delta_linf: float, error_msg: Optional[str] = None):
